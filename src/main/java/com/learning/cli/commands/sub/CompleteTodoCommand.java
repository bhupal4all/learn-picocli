...
@CommandLine.Command(name = "complete",
        ...
        description = "This is a Sub Command to 'todo' and marks the todo as completed",
        header = "Complete Todo SubCommand",
...
public class CompleteTodoCommand implements Callable<Integer> {
    ...
    public Integer call() throws Exception {
        ...
        if (Objects.nonNull(id) && id.size() > 0) {
            id.stream().forEach(_id -> todoService.markCompletedById(_id));
        }
